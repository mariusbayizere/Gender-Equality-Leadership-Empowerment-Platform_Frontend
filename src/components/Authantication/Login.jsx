...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store token and user data in memory (since localStorage is not available)
      // You can use React context or state management for this
      const userData = {
        token: data.token,
        user: data.user
      };
      ...
      setTimeout(() => {
        ...
        window.location.href = '/dashboard'; // Uncomment in real app
      }, 2000);
