...
// import { 
//   X, Eye, Star, Users, BookmarkPlus, Heart, Share2, Download, 
//   PlayCircle, BookOpen, CheckCircle, Play, ChevronRight, Award, Clock, Volume2, VolumeX
// } from 'lucide-react';
...
//     duration: "4.5 hours",
//     modules_count: 5,
//     description: "Master the art of leadership with this comprehensive course covering communication, team management, and strategic planning.",
...
//   const [currentModuleIndex, setCurrentModuleIndex] = useState(2); // Start with "Team Management" as current
...
//     // Mark previous modules as completed if playing a new module
...
//     // Auto-play the selected module after a brief delay
//     setTimeout(() => {
//       handlePlayClick();
//     }, 500);
//   };
...
//           </button>
//           <div>
//             <h1 className="text-xl font-bold">{currentModule?.title || hardcodedData.title}</h1>
...
//                 <span>{hardcodedData.enrolled} enrolled</span>
//               </div>
//             </div>
//           </div>
//         </div>
...
//             className={`p-2 rounded-lg transition-colors ${
//               isBookmarked ? 'bg-blue-600 hover:bg-blue-700' : 'hover:bg-gray-700'
//             }`}
//           >
...
//             className={`p-2 rounded-lg transition-colors ${
//               isLiked ? 'bg-red-600 hover:bg-red-700' : 'hover:bg-gray-700'
//             }`}
//           >
...
//                         className="w-32 h-32 bg-gradient-to-br from-red-600 to-red-700 rounded-2xl flex items-center justify-center mb-4 hover:from-red-700 hover:to-red-800 transition-all duration-300 shadow-2xl transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-red-500 focus:ring-opacity-50"
//                       >
//                         <Play className="w-12 h-12 ml-2 text-white" fill="white" />
//                       </button>
//                       <div className="absolute inset-0 w-32 h-32 bg-red-500 rounded-2xl animate-ping opacity-20 pointer-events-none"></div>
//                     </div>
//                     <h3 className="text-2xl font-bold mb-3 max-w-md mx-auto">{currentModule?.title}</h3>
...
//                           <PlayCircle className="w-16 h-16 animate-spin text-red-500" />
//                         </div>
...
//                           {isMuted && (
//                             <VolumeX className="w-4 h-4 ml-2 text-red-400" />
//                           )}
//                         </div>
//                       </div>
//                     </div>
...
//                         <div className="flex items-center space-x-2">
//                           <span className="text-xs bg-red-600 px-2 py-1 rounded">Module {currentModuleIndex + 1}</span>
//                         </div>
//                       </div>
//                     </div>
//                   </div>
...
//                 <p className="text-gray-300 mb-2">Unable to load video content</p>
...
//                 {hardcodedData.instructor_name.charAt(0).toUpperCase()}
//               </div>
//               <div>
...
//                   <span>{hardcodedData.modules_count} modules</span>
//                 </div>
//               </div>
//             </div>
...
//                 Course Modules ({hardcodedData.modules_count})
//               </h4>
...
//                     className={`p-3 rounded-lg border transition-all duration-200 cursor-pointer transform hover:scale-[1.02] ${
//                       module.current 
...
//                         module.current ? 'text-blue-500 transform rotate-90' : 'text-gray-400'
//                       }`} />
//                     </div>
//                   </div>
//                 ))}
...
//               <button className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-3 px-4 rounded-xl font-semibold transition-all duration-200 shadow-lg">
//                 Continue Learning
//               </button>
              
//               <div className="grid grid-cols-2 gap-2">
//                 <button className="border border-gray-300 text-gray-700 hover:bg-gray-50 py-2 px-4 rounded-lg font-medium transition-colors text-sm">
//                   Take Notes
//                 </button>
//                 <button className="border border-gray-300 text-gray-700 hover:bg-gray-50 py-2 px-4 rounded-lg font-medium transition-colors text-sm">
//                   Ask Question
