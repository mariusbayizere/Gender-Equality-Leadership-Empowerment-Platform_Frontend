...
const ExpandedCourseView = ({ 
  ...
  // Function to mark current module as completed (can be called when video ends)
  ...
  // Simulate completing the current module after watching for some time
  useEffect(() => {
            ...
            <button 
              onClick={() => {
                if (isAllModulesCompleted) {
                  // Handle course completion - could show certificate or redirect
