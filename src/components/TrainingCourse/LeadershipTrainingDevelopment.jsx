...
//           course.course_type === 'online' ? 'from-blue-500 to-blue-600' :
...
//               course.course_type === 'online' ? 'bg-blue-500 bg-opacity-30' :
...
//           <StatsCard 
//             title="Live Sessions" 
//             value={courses.filter(c => c.course_type === 'webinar').length} 
//             icon={Video} 
